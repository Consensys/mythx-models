...
The MythX domain models could always use more documentation, whether as part of the
official MythX docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python, 3.5 and 3.6, and 3.7. Check
   https://travis-ci.org/dmuhs/mythx-models/pull_requests
